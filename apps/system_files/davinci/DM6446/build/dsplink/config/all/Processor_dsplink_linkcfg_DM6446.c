...
/* ------- original CFG_Davinci_DM6446.c, possibly adapted for CE: --------- */

/** ===========================================================================
 *  @file   CFG_Davinci_DM6446.c
 *
...
STATIC CONST LINKCFG_Gpp  LINKCFG_gppObject = {
    ...
    3,           /* PROBERTCID     : Real Time Clock ID for PROBE */
    33           /* PROBEINTID     : Interrupt ID for PROBE */
} ;
