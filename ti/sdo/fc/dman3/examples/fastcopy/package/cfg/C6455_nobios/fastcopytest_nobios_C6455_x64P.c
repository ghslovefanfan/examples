 ...
 */
__FAR__ char* __ASM__ = "@(#)__ASM__ = /db/atree/library/trees/fc-e20x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/C6455_nobios/fastcopytest_nobios_C6455_x64P";
