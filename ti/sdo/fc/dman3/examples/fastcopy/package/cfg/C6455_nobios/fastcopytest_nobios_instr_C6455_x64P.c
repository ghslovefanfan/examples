...
far Uns DMAN3_QDMA_QUEUE_MAP[5] = {
    1,
    1,
    1,
    1,
 ...
 */
__FAR__ char* __ASM__ = "@(#)__ASM__ = /db/atree/library/trees/fc-e20x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/C6455_nobios/fastcopytest_nobios_instr_C6455_x64P";
 ...
 */
__FAR__ char* __PLAT__ = "@(#)__PLAT__ = ti.platforms.sim6xxx";
...
#include <xdc/std.h>
#ifndef __config__
__FAR__ char ti_sdo_fc_dman3_examples_fastcopy__dummy__;
#define __xdc_PKGVERS null
#define __xdc_PKGNAME ti.sdo.fc.dman3.examples.fastcopy
#define __xdc_PKGPREFIX ti_sdo_fc_dman3_examples_fastcopy_
#ifdef __xdc_bld_pkg_c__
#define __stringify(a) #a
#define __local_include(a) __stringify(a)
#include __local_include(__xdc_bld_pkg_c__)
