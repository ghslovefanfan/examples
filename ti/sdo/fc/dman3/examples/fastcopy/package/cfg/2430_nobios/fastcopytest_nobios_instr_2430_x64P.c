...
far Uns DMAN3_QDMA_CHANNELS[2] = {
    0,
    1
};

far Uns DMAN3_QDMA_QUEUE_MAP[2] = {
    1,
    1
};
 ...
 */
__FAR__ char* __ASM__ = "@(#)__ASM__ = /db/atree/library/trees/fc-e20x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/2430_nobios/fastcopytest_nobios_instr_2430_x64P";
