 ...
 */
__FAR__ char* __ASM__ = "@(#)__ASM__ = /db/atree/library/trees/fc-e20x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/dm6446_nobios/fastcopytest_nobios_dm6446_x64P";
