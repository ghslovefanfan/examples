 ...
 */
__FAR__ char* __ASM__ = "@(#)__ASM__ = /db/atree/library/trees/fc-e20x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/dm6437_nobios/fastcopytest_nobios_dm6437_x64P";
