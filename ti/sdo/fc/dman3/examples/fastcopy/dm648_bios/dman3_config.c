...
static Uns CFG_QDMA_CHANNELS[2] = { 0, 1};
#define DMAN3MAXQDMACHANNELS 4;
#define DMAN3NUMQDMACHANNELS 2;
...
#define DMAN3QDMAPARAMBASE 0x2A04000;
...
{
    DMAN3_PARAMS.qdmaPaRamBase = (Uns *)DMAN3QDMAPARAMBASE;
