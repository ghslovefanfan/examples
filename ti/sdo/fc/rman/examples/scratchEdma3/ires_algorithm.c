    ...
    IRES_ResourceDescriptor *resourceDescriptors)
{
    ...
    algHandle->protocolArgs[0].numTccs = 4; 
    algHandle->protocolArgs[0].tccIndex = IRES_EDMA3CHAN_TCC_ANY;
 ...
 */
/*         algHandle->protocolArgs[i].numPaRams = 64; */
...
/*         algHandle->protocolArgs[i].paRamIndex = 21 + i;*/
/*         algHandle->protocolArgs[i].contiguousAllocation = (i%2);*/
        algHandle->protocolArgs[i].edmaChan = IRES_EDMA3CHAN_EDMACHAN_ANY;
