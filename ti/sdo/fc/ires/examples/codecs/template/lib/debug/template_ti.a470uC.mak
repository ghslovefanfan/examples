...
package/lib/lib/debug/template_ti/template_ti_ires.o470uC: template_ti_ires.c lib/debug/template_ti.a470uC.mak
	...
	$(RM) $@
	@$(MSG) cl470uC $< ...
	$(gnu.targets.UCArm9.rootDir)/bin/arm-linux-gcc -c -MD -MF $@.dep -x c  -Wunused -D_REENTRANT   -Dfar=  -D_DBG_ -DDBC_ASSERTS=1 -DGT_ASSERT=0 -DGT_TRACE=0  -Dxdc_target_name__=UCArm9 -Dxdc_target_types__=gnu/targets/std.h -Dxdc_bld__profile_bridge_debug -Dxdc_bld__vers_1_0_4_2_1 -g  $(XDCINCS)  -o $@ $<
	-@$(FIXDEP) $@.dep $@.dep
...
package/lib/lib/debug/template_ti/template_ti_ires.s470uC: template_ti_ires.c lib/debug/template_ti.a470uC.mak
	...
	$(RM) $@
	@$(MSG) cl470uC -S $< ...
	$(gnu.targets.UCArm9.rootDir)/bin/arm-linux-gcc -c -MD -MF $@.dep -x c -S -Wunused -D_REENTRANT   -Dfar=  -D_DBG_ -DDBC_ASSERTS=1 -DGT_ASSERT=0 -DGT_TRACE=0  -Dxdc_target_name__=UCArm9 -Dxdc_target_types__=gnu/targets/std.h -Dxdc_bld__profile_bridge_debug -Dxdc_bld__vers_1_0_4_2_1 -g  $(XDCINCS)  -o $@ $<
	-@$(FIXDEP) $@.dep $@.dep
