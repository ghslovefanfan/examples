...
_ti_sdo_ce_bioslog_trackPrd = ti_sdo_ce_bioslog_trackPrd;
...
MEMORY {
   ...
   CACHE_L1D   : origin = 0x11f07000,  len = 0x1000
   DDRALGHEAP  : origin = 0x88000000,  len = 0x7a00000
   DDR2        : origin = 0x8fa00000,  len = 0x400000
   DSPLINKMEM  : origin = 0x8fe00000,  len = 0x100000
   RESET_VECTOR : origin = 0x8ff00000, len = 0x80
   ARM_RAM     : origin = 0x10010000,  len = 0x8000
   L1DSRAM     : origin = 0x11f00000,  len = 0x7000
...
SECTIONS {
        ...
        .hst: {
            ...
            HST_A_TABEND = .;
            _HST_A_TABEND = .;
             HST_A_TABLEN = (. - _HST_A_TABBEG) / 28;
            _HST_A_TABLEN = (. - _HST_A_TABBEG) / 28;
        } > DDR2
        ...
        .DDRALGHEAP$heap: {
            DDRALGHEAP$B = .;
            _DDRALGHEAP_base = .;
            DDRALGHEAP$L = 0x7a00000;
            _DDRALGHEAP_length = 0x7a00000;
            . += 0x7a00000;
        } > DDRALGHEAP
