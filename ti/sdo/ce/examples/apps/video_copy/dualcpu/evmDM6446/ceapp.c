...
int ceapp_validateBufSizes(int inBufSize, int encodedBufSize, int outBufSize)
{
    ...
    /* FYI, show which physical buffers were registered */
...
/*
 *  @(#) ti.sdo.ce.examples.apps.video_copy.dualcpu.evmDM6446; 1, 0, 0,83; 9-9-2008 02:01:53; /db/atree/library/trees/ce-h27x/src/
 */
