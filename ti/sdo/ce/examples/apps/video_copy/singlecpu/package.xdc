...
/*!
 *  ======== package.xdc ========
 *  Codec Engine encode-decode example which utilizes video codecs that
 *  implement the 0.9 xDM video interfaces.
 *
 ...
 *          application.
 */
package ti.sdo.ce.examples.apps.video_copy.singlecpu {
}
/*
