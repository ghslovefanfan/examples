...
/*!
 *  ======== package.xdc ========
 *  Codec Engine video analytics example which utilizes a codec that
 *  implements the xDM video analytics interface.
 *
 ...
 *          application.
 */
package ti.sdo.ce.examples.apps.vidanalytics [1, 0, 0] {
}
/*
