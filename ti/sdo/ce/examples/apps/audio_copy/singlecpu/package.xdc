...
/*!
 *  ======== package.xdc ========
 *  Codec Engine encode-decode example which utilizes audio codecs that
 *  implement the 0.9 xDM audio interfaces.
 *
 *  This example builds using the XDC build tools, and is portable to
 *  multiple single procesor execution environments.  The following files are
...
/*
 *  @(#) ti.sdo.ce.examples.apps.audio_copy.singlecpu; 1,0,0,135; 9-9-2008 02:00:40; /db/atree/library/trees/ce-h27x/src/
 */
