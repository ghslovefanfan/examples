 ...
 *  codec which implements the 0.9 xDM speech interface.
 *
...
/*
 *  @(#) ti.sdo.ce.examples.apps.speech.linuxonly; 1,0,0,134; 9-9-2008 02:01:17; /db/atree/library/trees/ce-h27x/src/
 */
