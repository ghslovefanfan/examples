...
requires ti.xdais.dm.examples.imgenc1_copy;

/*!
 *  ======== package.xdc ========
 *  Simple Codec Engine compatible image 1.0 "encoder", wrapping the image 1.0
 ...
 *      - `IMGENC1_COPY.xdc`
 *          This file specifies a codec (named IMGENC1_COPY) that is
 ...
 *  libraries.
 */
package ti.sdo.ce.examples.codecs.imgenc1_copy {
    module IMGENC1_COPY;
}
/*
