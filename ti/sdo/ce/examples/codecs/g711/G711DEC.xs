 ...
 *  ======== G711DEC.xs ========
 *
 *  This file implements the functions specified in the
 *  ti.sdo.ce.speech1.ISPHDEC1 interface.  These functions enable the
 *  configuration tool to validate user supplied configuration
 *  parameters (e.g., stack size for the thread running this codec).
 */
